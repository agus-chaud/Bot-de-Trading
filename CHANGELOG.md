...
### Added
- **Golden replay (T0.2)** — `tests/fixtures/replay_golden/` + `tests/test_replay_golden.py`: caracterización de `replay_ledger_from_fills` (fills multi-día → estado de ledger esperado) antes de persistencia de capital (**T1.1**).
